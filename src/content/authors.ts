export type Author = {
  ...
  role: string;
  bio: string;
  /** Short (<=155 char) meta description for the author route. Falls back to bio if unset. */
...
export const authors: Record<string, Author> = {
  salman: {
    ...
    metaDescription: "Co-founder of Yonovo. Salman writes about AR strategy, DSO reduction, and practical collections automation for SMB finance teams.",
  ...
  alex: {
    ...
    metaDescription: "Co-founder & CEO of Yonovo (and Boast.ai). Alex writes on scaling operations, efficiency, and the intersection of finance and technology.",
