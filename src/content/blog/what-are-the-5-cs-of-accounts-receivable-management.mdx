...
Define what happens at each score level. A combined weighted score above 2.5 might qualify for Net 30 with standard terms. A score between 1.5 and 2.5 might get Net 15 with a reduced credit limit. Below 1.5 might require prepayment or a letter of credit. Scores only set the starting terms. For what to do when an approved customer later stops paying on time, see [how and when to use a credit hold](/blog/credit-hold).
