...
heroImage: "/images/blog/how-to-reduce-dso.png"
heroImageAlt: "Downward trending bar chart with clock and dollar coin illustrating DSO reduction"
...
faqs:
  ...
  - question: "What is a good DSO for manufacturing companies?"
    answer: "Manufacturing DSO typically ranges from 45 to 55 days. Best-in-class manufacturers maintain DSO under 40 days by automating reminders, resolving disputes quickly, and offering multiple payment methods. The key challenge in manufacturing is that disputed invoices can cascade into production delays, making fast resolution critical."
  - question: "How do professional services firms reduce DSO?"
    answer: "Professional services firms typically see DSO between 35 and 50 days. The most effective strategies include invoicing immediately at project milestones rather than waiting for completion, requiring deposits for new engagements, automating follow-up sequences, and building payment expectations into client onboarding. Firms that automate collections typically reduce DSO by 10 to 15 days without damaging referral relationships."
...
## Industry-specific DSO strategies

The strategies above apply universally, but each industry has unique challenges that affect how you implement them. Here is what works in the sectors where DSO management matters most.

### Manufacturing and distribution

Manufacturing companies deal with large invoice amounts, complex payment terms, and frequent disputes over delivery or quality. The average DSO in manufacturing sits between 45 and 55 days.

The most effective approach is to automate reminders starting on day one of overdue status. Do not wait. Resolve disputes within 48 hours by assigning them to specific team members with clear deadlines. Segment customers by payment risk and apply different follow-up cadences for reliable payers versus repeat offenders. For field-based buyers who rarely check email, [SMS and phone outreach](/blog/multi-channel-payment-chasing) significantly outperform email-only sequences.

Learn more about [AR challenges in manufacturing](/industries/manufacturing) and [wholesale distribution](/industries/wholesale-distribution). For a deeper look at why manual AR in these sectors creates outsized financial risk, see our analysis of [manual AR in heavy industries](/blog/manual-ar-heavy-industries-financial-risk).

### Professional services

Professional services firms face a unique tension: aggressive collections can damage the referral relationships that drive new business. DSO in this sector typically ranges from 35 to 50 days.

The biggest lever is invoicing at project milestones rather than waiting for completion. Set payment expectations during client onboarding, not after the first invoice is overdue. Use friendly automated [reminders](/blog/invoice-reminder-best-practices) that maintain your firm's professional tone. When escalation is needed, route it through a partner or senior contact rather than a collections process.

For firms that bill on retainer, consider requiring deposits for new engagements and implementing automatic payment methods for recurring fees. Learn more about [AR automation for professional services](/industries/professional-services).

### Wholesale and distribution

High invoice volume and thin margins make DSO management critical in wholesale. Every day of delayed payment directly impacts your ability to restock and fulfill new orders.

Offer early payment discounts (2/10 Net 30) to incentivize faster payment. Automate at scale since manual follow-up simply does not work when you are managing hundreds of invoices. Segment customers by payment history to focus your team's energy where it matters most. For operations-focused buyers who spend their day on warehouse floors rather than at desks, SMS reminders consistently outperform email.
