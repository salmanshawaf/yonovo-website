...
This also shows up in your reporting. When you run a [cash flow analysis](/blog/cash-flow-analysis), the working capital line stops swinging unpredictably, because receivables are no longer the variable nobody controls.
