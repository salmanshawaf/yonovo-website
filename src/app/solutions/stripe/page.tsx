...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: SITE_NAME,
    images: [{ url: "/api/og?title=Stripe%20Billing%20AR%20Automation&category=guides", width: 1200, height: 630, alt: "Stripe Billing AR Automation" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["/api/og?title=Stripe%20Billing%20AR%20Automation&category=guides"],
    title: `Stripe Billing AR Automation | ${SITE_NAME}`,
    description:
