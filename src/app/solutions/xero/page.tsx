...
import XeroPage, { faqs } from "@/components/XeroPage";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: SITE_NAME,
    images: [{ url: "/api/og?title=Xero%20AR%20Automation%20%7C%20Automate%20Collections%20for%20Xero&category=guides&label=Solution", width: 1200, height: 630, alt: "Xero AR Automation | Automate Collections for Xero" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["/api/og?title=Xero%20AR%20Automation%20%7C%20Automate%20Collections%20for%20Xero&category=guides&label=Solution"],
