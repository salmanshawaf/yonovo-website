...
import NetSuitePage, { faqs } from "@/components/NetSuitePage";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: SITE_NAME,
    images: [{ url: "/api/og?title=NetSuite%20AR%20Automation&category=guides&label=Solution", width: 1200, height: 630, alt: "NetSuite AR Automation" }],
  },
  twitter: {
    card: "summary_large_image",
    images: ["/api/og?title=NetSuite%20AR%20Automation&category=guides&label=Solution"],
    title: `NetSuite AR Automation | ${SITE_NAME}`,
    description:
      "Automate accounts receivable for NetSuite. Sync invoices, send multi-channel follow-ups, and reduce DSO.",
  },
