            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                ...
                <div className="flex shrink-0 flex-row items-center gap-6">
                  <Link href="/book-demo"><Button variant="brand" size="md" className="h-14 px-[46px] text-lg font-medium whitespace-nowrap">Book Demo</Button></Link>
                  <Link href="https://dashboard.yonovo.ai/login"><Button variant="ghost-light" size="md" className="h-14 whitespace-nowrap">Start Free</Button></Link>
                </div>
              </div>
            </div>
