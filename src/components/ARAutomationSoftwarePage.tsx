...
const proofLogos: { name: string; src: string; width: number; className: string }[] = [
  { name: "Conveyor", src: "/logos/conveyor.svg", width: 145, className: "h-[26px] lg:h-[28px]" },
  { name: "Lawazim", src: "/logos/lawazim.svg", width: 156, className: "h-[13px] lg:h-[14px]" },
  { name: "Troyes", src: "/logos/troyes.png", width: 130, className: "h-[36px] lg:h-[40px]" },
  { name: "SBC", src: "/logos/sbc.png", width: 200, className: "h-[80px] lg:h-[80px]" },
];
