...
const optimizeLinks = [
  { label: "AR Automation Software", href: "/accounts-receivable-automation-software" },
  { label: "Debt Collection Software", href: "/debt-collection-software" },
  { label: "AR Collections Software", href: "/ar-collections-software" },
  { label: "Dunning Management", href: "/dunning-management-software" },
];
...
const resourceLinks = [
  ...
  { label: "AR Statistics", href: "/accounts-receivable-statistics" },
...
const compareLinks = [
  ...
  { label: "Yonovo vs Bill.com", href: "/yonovo-vs-bill-com" },
];
...
const linkSections = [
  ...
  { title: "OPTIMIZE YOUR AR", links: optimizeLinks },
  ...
  return (
    <footer className="text-white bg-brand-navy">
      <div className="mx-auto max-w-(--container-max-width) px-6 pt-28 pb-12">
        ...
        {/* ===== DESKTOP LAYOUT (md+) ===== */}
        <div className="hidden md:flex md:flex-row md:justify-between md:gap-12">
          {/* Left column */}
          <div className="flex flex-col items-start gap-8">
            ...
            <div className="flex items-center gap-4">
              <a href="mailto:salman@yonovo.com">
                <button className="flex h-11 items-center justify-center rounded-md border border-white/20 bg-transparent px-5 py-3 font-medium text-base text-white transition-all duration-200 hover:bg-white/10">
                  Contact
                </button>
              </a>
              <a href="https://www.linkedin.com/company/yonovoai" target="_blank" rel="noopener noreferrer">
                <button className="flex h-11 w-11 items-center justify-center rounded-md border border-white/20 p-3 text-white transition-all duration-200 hover:bg-white/10" aria-label="LinkedIn">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path fillRule="evenodd" clipRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" />
                  </svg>
                </button>
              ...
              <a href="https://www.youtube.com/@TractionFM" target="_blank" rel="noopener noreferrer">
                <button className="flex h-11 w-11 items-center justify-center rounded-md border border-white/20 p-3 text-white transition-all duration-200 hover:bg-white/10" aria-label="YouTube">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M23.498 6.186a2.966 2.966 0 00-2.084-2.084C19.654 3.333 12 3.333 12 3.333s-7.654 0-9.414.769A2.966 2.966 0 00.502 6.186C0 8.102 0 12 0 12s0 3.898.502 5.814a2.966 2.966 0 002.084 2.084c1.76.769 9.414.769 9.414.769s7.654 0 9.414-.769a2.966 2.966 0 002.084-2.084C24 15.898 24 12 24 12s0-3.898-.502-5.814zM9.545 15.568v-7.136L15.545 12l-6 3.568z" />
                  </svg>
                </button>
          ...
          {/* Right columns — Links */}
          <div className="flex flex-wrap gap-x-6 gap-y-10 xl:gap-x-8">
