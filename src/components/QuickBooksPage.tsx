...
const timelineSteps = [
  ...
  },
  {
    ...
    illustration: StepSyncIllustration,
  },
  {
    number: 3,
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Book a demo with our team. We'll connect QuickBooks, show you Yonovo running on your real invoices, and get you set up. Most teams are live within a day.",
  },
];
        ...
        <div className="mx-auto max-w-(--container-max-width) px-6">
          <div className="flex flex-col gap-8 md:gap-16">
            ...
            <div className="flex flex-col gap-6 md:grid md:grid-cols-[2fr_3fr] md:gap-8">
              {/* Left — QuickBooks connect animation (square) */}
