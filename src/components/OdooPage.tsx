...
import { Step1OdooIllustration } from "@/components/Step1Illustrations";
import {
...
const timelineSteps = [
  {
    ...
    illustration: Step1OdooIllustration,
  },
  {
    number: 2,
    text: "Yonovo automatically syncs your invoices, contacts, and payment data.",
    illustration: () => <StepSyncIllustration ledger="Odoo" />,
  },
  {
    number: 3,
...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Most teams are live within one day. Connect Odoo, set your preferences, and Yonovo starts working on your overdue invoices right away.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Book a demo with our team. We'll connect Odoo, show you Yonovo running on your real invoices, and get you set up. Most teams are live within a day.",
  },
];
        ...
        <div className="mx-auto max-w-(--container-max-width) px-6">
          <div className="flex flex-col gap-8 md:gap-16">
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                <p className="text-balance text-base text-zinc-400 tracking-tight md:text-xl">
                  Yonovo is Odoo AR automation. It connects to Odoo and takes over the collections process. Every overdue invoice gets followed up by email, text, and phone so your team can stop spending hours on manual reminders.
                </p>
            ...
            <div className="flex flex-col gap-6 md:grid md:grid-cols-[2fr_3fr] md:gap-8">
              {/* Left — Odoo connect animation (square) */}
