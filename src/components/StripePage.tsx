...
const problems = [
  {
    title: "No visibility",
    description:
      "Stripe shows you what is paid and what is due, but not who is at risk. Your team is left guessing on DSO and collection priorities.",
  },
  {
  ...
  },
  {
    title: "Late payments",
    description:
      "Failed charges and unpaid invoices quietly pile up. Every day an invoice goes uncollected costs you cash flow.",
  },
];

const comparisonFeatures = [
  { feature: "Invoice creation and tracking", stripe: true, yonovo: true },
  { feature: "Recurring billing and subscriptions", stripe: true, yonovo: true },
  { feature: "Card, ACH, and SEPA payments", stripe: true, yonovo: true },
  { feature: "Automated payment reminders", stripe: false, yonovo: true },
  { feature: "Multi-channel follow ups (email, SMS, phone)", stripe: false, yonovo: true },
  { feature: "AI-powered collection strategies", stripe: false, yonovo: true },
  { feature: "Customer risk scoring", stripe: false, yonovo: true },
  { feature: "Escalation workflows", stripe: false, yonovo: true },
  { feature: "Real time AR dashboard", stripe: false, yonovo: true },
  { feature: "DSO reduction tracking", stripe: false, yonovo: true },
];
...
export const faqs = [
  {
    question: "How does Yonovo connect to Stripe Billing?",
    answer:
      "Yonovo uses a secure connection. Click \"Connect,\" authorize Stripe access with a few permissions, and your data syncs automatically. Setup takes minutes, with no coding or custom work required.",
  },
  {
    question: "What Stripe Billing data does Yonovo access?",
    answer:
      "Yonovo imports your customers, invoices, and payments from Stripe Billing. After an initial sync, everything stays up to date in real time, so your AR team always works from accurate data without manual exports.",
  },
  {
    question: "What happens when a customer pays through the Yonovo portal?",
    answer:
      "Payments made through the Yonovo portal are written back to Stripe automatically. The invoice is marked paid so your Stripe records stay in sync without disrupting your accounting flow.",
  },
  {
    question: "Will all of my Stripe invoices show up in Yonovo?",
    answer:
      "Active invoices sync into Yonovo in real time. Draft invoices are excluded to keep your workflow focused, while voided and uncollectible invoices are imported with the correct status so only relevant, actionable invoices appear in your collections process.",
  },
  {
    question: "Can I sync Stripe metadata or custom fields into Yonovo?",
    answer:
      "Yes. You can bring Stripe metadata into Yonovo as custom fields for customers, invoices, and payments. Native Stripe fields like default payment method, delinquent status, and tax location can also be surfaced for more granular reporting and workflow rules.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Book a demo with our team. We'll connect Stripe Billing, show you Yonovo running on your real invoices, and get you set up. Most teams are live within a day.",
  },
];
  ...
  return (
    <>
          ...
          <div className="flex flex-col gap-8 md:gap-16">
            ...
            <div className="flex flex-col gap-4 md:gap-6">
              ...
              <h1 className="text-balance font-medium text-[42px] text-white leading-[1.1] tracking-tight md:text-[70px]">
                Sync Stripe Billing and get paid
              </h1>
              <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                <p className="text-balance text-base text-zinc-400 tracking-tight md:text-xl">
                  Yonovo is Stripe Billing AR automation. It connects to Stripe Billing and takes over the collections process. Every overdue invoice gets followed up by email, text, and phone so your team can stop spending hours on manual reminders.
                </p>
            ...
            <div className="flex flex-col gap-6 md:grid md:grid-cols-[2fr_3fr] md:gap-8">
              ...
              <div className="relative flex h-40 w-full items-center justify-center overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] md:hidden">
                <Image src="/logos/stripe.svg" alt="Stripe Billing" width={320} height={134} className="w-[50%] h-auto" />
              </div>
            </div>
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:gap-16">
            ...
            <div className="flex flex-1 flex-col gap-4">
              ...
              <h2 className="text-balance font-medium text-4xl text-foreground leading-tight tracking-tight md:text-[54px]">
                Stripe Billing wasn&apos;t made for collections
              </h2>
              <p className="text-balance text-base text-secondary leading-normal tracking-tight md:text-xl">
                Stripe Billing is great at invoicing, subscriptions, and processing payments. But it was never designed to chase what is owed after an invoice goes out. That gap falls on your team, and it is costing you time, cash flow, and focus every single week.
              </p>
            </div>
          ...
          <div className="flex flex-col gap-8 md:gap-16">
            ...
            <div className="grid grid-cols-1 items-end gap-8 md:grid-cols-2 md:gap-16">
              <div className="flex flex-1 flex-col gap-4">
                ...
                <h2 className="text-balance font-medium text-4xl text-foreground leading-tight tracking-tight md:text-[54px]">
                  Yonovo picks up where Stripe Billing stops
                </h2>
              </div>
              ...
              {[
                {
                  ...
                  desc: "Customers, invoices, and payments stay current in real time. Bring Stripe metadata in as custom fields too.",
                },
                {
                  icon: (
                    <svg className="h-6 w-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round">
        ...
        <div className="mx-auto max-w-(--container-max-width) px-6">
          <div className="flex flex-col items-center gap-8 md:gap-14">
            ...
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="text-base text-secondary leading-normal tracking-tight md:text-xl">
                See what your Stripe Billing setup is missing and what you unlock when you add Yonovo.
              </p>
            </div>
            ...
            <div className="hidden md:block overflow-hidden rounded-2xl border border-border bg-background max-w-3xl w-full">
              ...
              <div className="grid grid-cols-[1fr_140px_220px] border-b border-border">
                ...
                <div className="flex items-center justify-center border-l border-border px-4 py-4">
                  <Image src="/logos/stripe.svg" alt="Stripe Billing" width={90} height={38} className="h-6 w-auto" />
                </div>
                <div className="flex items-center justify-center gap-1.5 border-l border-brand-green/30 bg-brand-green/5 px-3 py-4">
                  <Image src="/logos/stripe-icon.svg" alt="Stripe" width={24} height={24} className="h-[26px] w-[26px] rounded-md" />
                ...
                <div key={row.feature} className="rounded-2xl border border-border bg-background p-4">
                  ...
                  <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2">
                      {row.stripe ? <CheckIcon /> : <XIcon />}
                      <span className="text-sm text-muted">Stripe Billing</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckIcon />
      ...
      <RelatedResources background="background" items={[
        { label: "Accounts Receivable Automation Software", href: "/accounts-receivable-automation-software", description: "How AR automation works and how ten leading platforms compare." },
        { label: "Debt Collection Software for B2B Invoices", href: "/debt-collection-software", description: "What B2B debt collection software does and how it differs from an agency." },
