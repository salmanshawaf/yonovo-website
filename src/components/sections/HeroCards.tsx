import { CARD, CARD_BASE, ClientAgentCard, ReplyCard } from "@/components/AgentCards";
/* Floating product-UI cards for the hero, recreated in code from real Yonovo screens.
   The AI assistant and customer-reply cards are shared with the industry pages. */
