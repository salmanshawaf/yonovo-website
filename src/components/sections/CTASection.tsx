...
export default function CTASection() {
  return (
    <section className="w-full bg-gradient-to-b from-surface from-60% to-primary to-60%">
      <div className="mx-auto max-w-[1600px] px-6">
        <div className="relative flex w-full flex-col items-center justify-center gap-6 overflow-hidden border-t border-border bg-white px-6 py-12 pb-30 md:gap-8 md:rounded-3xl md:border md:p-15 lg:p-25">
          ...
          <div className="pointer-events-none absolute bottom-0 left-0 h-auto w-[40%] md:h-[40%] md:w-auto lg:h-[50%]">
            <div className="h-[350px] w-[350px] rounded-full bg-gradient-to-tr from-[#FB923C] via-[#F472B6] to-[#E879F9] opacity-70 blur-3xl" />
          </div>
          {/* Gradient blob right */}
          <div className="pointer-events-none absolute right-0 bottom-0 h-auto w-[40%] md:h-[40%] md:w-auto lg:h-[50%]">
            <div className="h-[350px] w-[350px] rounded-full bg-gradient-to-tl from-[#FB923C] via-[#F472B6] to-[#E879F9] opacity-70 blur-3xl" />
          </div>
          ...
          <div className="flex flex-col gap-4 md:max-w-[850px] md:gap-6">
            ...
            <p className="text-center font-normal text-base text-zinc-600 tracking-[-0.4px] md:text-xl">
              Use Chatbase to deliver exceptional support<br className="hidden md:inline" />
          ...
          <div className="flex w-full flex-col items-center justify-center gap-6 md:gap-4">
            <div className="relative z-0 h-14 w-full md:w-fit">
              <div className="-z-1 absolute right-0 bottom-[-8px] left-0 h-full w-full rounded-lg bg-gradient-to-r from-[#FB923C] via-[#F472B6] to-[#E879F9]" />
              <a
                href="#"
                className="flex h-full w-full items-center justify-center rounded-lg bg-primary px-6 py-2 font-semibold text-base text-white hover:bg-primary"
              >
